...
# grade별 value 리스트 만들기 
    ...
    for key in grade_dic.keys():
        ...
        grade_calculate_dic[key]['min'] = min(grade_dic[key]) # 각 grade 별 최솟값
        grade_calculate_dic[key]['max'] = max(grade_dic[key]) # 각 grade 별 최댓값
    ...
    '''
    # 과제 위 코드가 마음에 안듬 ---> pandas 문법으로 변환해서 2개 Tasks를 완료
    ...
    request.session['grade_calculate_pd_dic] = grade_calculate_dic_pd_to_sesstion
    # print("")
